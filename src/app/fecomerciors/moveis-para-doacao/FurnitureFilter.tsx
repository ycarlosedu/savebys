...
export default function FurnitureFilter() {
  ...
  return (
    <div className="border-gray-secondary border-2 text-white self-start items-start flex flex-col md:flex-row md:items-center min-w-fit gap-6 p-4 md:p-8 rounded-[32px]">
