...
function CardSkeleton({ className, ...props }: CardProps) {
  return (
    <div className={cn("flex gap-6 p-4 w-full", className)} {...props}>
      <Skeleton className="min-w-[100px] min-h-[100px] bg-gray-primary rounded-lg"></Skeleton>
      <div className="flex flex-col gap-1 w-full">
        <Skeleton className="w-full max-w-[120px] md:max-w-[220px] h-[24px] bg-gray-primary rounded-lg"></Skeleton>
        <Skeleton className="w-full max-w-[100px] h-[24px] bg-gray-primary rounded-lg"></Skeleton>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="bg-gray-secondary text-white self-start flex flex-col items-start gap-3 p-4 md:p-8 rounded-[32px] w-full">
      <div className="flex items-center justify-between w-full">
        ...
        <Skeleton className="w-[174px] md:w-[300px] h-[56px] md:h-[32px] bg-gray-primary rounded-lg"></Skeleton>
      </div>
